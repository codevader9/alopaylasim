-- =============================================
-- PAYLAŞIM PANELİ v2 - SPOR PAYLAŞIM SİSTEMİ
-- =============================================

-- 1. Sites - Çoklu site desteği
...
-- 3. Social Accounts - Site bazlı sosyal hesaplar
...
-- 5. Scheduled Posts - Zamanlanmış paylaşımlar
...
-- 6. Post History - Paylaşım geçmişi
...
-- 7. Retweet Accounts - RT hesapları
...
-- 8. Retweet Configs - RT otomasyon ayarları
...
-- 9. Telegram Menus - Reply Keyboard
...
-- 10. Tweet Templates - Site bazlı tweet şablonları
...
-- 11. Image Templates - Görsel şablonları
